...
@section('edithr')
    <div class="employee-form">
        ...
        <form action="/hr_viewemployee/{{$hr->id}}" style="margin-top: 10rem" method="POST" class="col-lg-4">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
            <h4 class="text-center" style="color: #2a88bd">Edit Employee</h4>
            ...
            <div class="form-group text-center">
                ...
                <a href="/hr_markattend/hr_viewemployee" class="btn btn-success" name="back" value="Back">Back</a>
            </div>
        </form>
    </div>
@endsection